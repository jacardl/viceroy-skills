...
### 助手效率（`assistant`，10 个）
- [baoyu-url-to-markdown](skills/assistant/baoyu-url-to-markdown/SKILL.md)
...
### 开发工程（`developer`，5 个）
- [scrapling](skills/developer/scrapling/SKILL.md)
