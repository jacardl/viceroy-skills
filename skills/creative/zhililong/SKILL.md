...
**材料关**：zhililong 篇幅长（4000-5500字），材料是唯一支撑。Step 1 的真实性核对是材料关的核心——不是改错字，是确认每段背后都有可查证的具体素材。用户给素材才能写，用户只给方向就要先研究再下笔。没有材料的段落，宁可砍掉也不能用想象补。

**推进关**：5节结构是骨架，每个论点的段落内部才是真正的推进。每个新段落必须带来新事实、新动作、新例子或新后果。5个论点之间要层层递进或互为补充，不能是同一个观点换5种说法。反转段要真的反转——颠覆读者预期，不是换个角度重述。

**中文关**：白话打底。让主语和动作先出现，再接时间、原因、条件。判断可以偏，把依据放在附近。不要用"更深一层""真正的问题"当路标，靠事情自身的逻辑推进。句尾的"呢""吧""了"是手迹，不要全删掉。

zhililong 现有规则（renwei 三原则、5节骨架）是三关在长文语境下的具体落地。
...
> ⚠️ **先找说话位置，再列骨架**。human-writing 要求在内部回答5件事：谁在说、他凭什么知道、手里有什么材料、他对哪点有判断、读者会追问什么。这5个答案决定了骨架怎么列，不是先有骨架再往里填内容。
...
> ⚠️ renwei 是 human-writing"中文关"的自动化检查。没有内化就下笔，5000 字长文一定掉进 AI 套话陷阱。

**三原则（human-writing 三关的自检映射）**：
1. **材料关**：开头 3 句话有没有具体场景/数字/来源？模型临时编的不算数。
2. **推进关**：每段比起上一段有没有新东西（新事实/新角度/新后果）？同一观点换说法是 filler。
3. **中文关**：句尾的"呢""吧""了"保留了吗？语气是"见过事的人在讲"，不是"导师在教学生"。

**五问自检（写每段前心里过一遍）**：
1. 谁在说？他凭什么知道这件事？
2. 手里的材料够不够撑这个段落的结论？
3. 这个段落比起上一个段落，有没有带来新东西？
4. 判断有没有落在具体事实旁边，让读者知道这是作者的看法？
5. 句尾有没有语气词，手迹感够不够？
