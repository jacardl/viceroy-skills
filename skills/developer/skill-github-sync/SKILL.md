...
| `assistant` | 助理 | find-skills, markitdown, markdown-to-report, neat-freak, obsidian, obsidian-cli, storage-analyzer, wechat-article-to-markdown, youtube-transcript |
...
| `operations` | 运营 | aihot, baoyu-url-to-markdown, geo系列(3个), github-daily-trending, radar系列(3个), scrapling, SEO系列(25个) |
